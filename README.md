...
MIT. See [LICENSE](LICENSE) — which includes both CodeWiki's MIT copyright (© 2026
0xsyncroot) and CodeGraph's original MIT copyright (© 2026 Colby McHenry) as required
by the derivative-work attribution — and [LICENSE-THIRD-PARTY.md](LICENSE-THIRD-PARTY.md)
for third-party crate and tree-sitter grammar attributions (generated by `cargo about`).
...
web UI, and i18n / Unicode search. See [LICENSE](LICENSE) for the full attribution,
