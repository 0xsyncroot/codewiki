...
-- Insert initial version (INSERT OR IGNORE so apply_schema is safe on existing DBs)
...
-- v6: explicit tokenizer with full Latin diacritic folding for Vietnamese/multilingual support
